...
# Note: This creates a warning: 'set_property' expects at least one object if no pins are used.

# Note that the bank voltage for IO Bank 33 is fixed to 3.3V on ZedBoard. 
set_property IOSTANDARD LVCMOS33 [get_ports -of_objects [get_iobanks 33]]; # 3.3 volt

# Set the bank voltage for IO Bank 34 to 1.8V by default.
# set_property IOSTANDARD LVCMOS33 [get_ports -of_objects [get_iobanks 34]]; # 3.3 volt setting
# set_property IOSTANDARD LVCMOS25 [get_ports -of_objects [get_iobanks 34]]; # 2.5 volt setting
set_property IOSTANDARD LVCMOS18 [get_ports -of_objects [get_iobanks 34]]; # 1.8 volt setting

# Set the bank voltage for IO Bank 35 to 1.8V by default.
# set_property IOSTANDARD LVCMOS33 [get_ports -of_objects [get_iobanks 35]]; # 3.3 volt setting
# set_property IOSTANDARD LVCMOS25 [get_ports -of_objects [get_iobanks 35]]; # 2.5 volt setting
set_property IOSTANDARD LVCMOS18 [get_ports -of_objects [get_iobanks 35]]; # 1.8 volt setting

# Note that the bank voltage for IO Bank 13 is fixed to 3.3V on ZedBoard. 
set_property IOSTANDARD LVCMOS33 [get_ports -of_objects [get_iobanks 13]]; # 3.3 volt
